...
function paintTodo(todo) {
    ...
    label.appendChild(checkbox); // label에 자식 요소로 label 추가
    checkbox.setAttribute('type', 'checkbox');
    checkbox.addEventListener('change', function() {
        todo.completed = !todo.completed;
        saveTodo();
    });
    todo.completed ? checkbox.setAttribute('checked', 'checked') : checkbox.removeAttribute('checked'); // 값이 true라면 체크박스에 checked 속성 추가하고 false면 속성 제거
