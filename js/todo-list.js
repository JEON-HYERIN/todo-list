...
const handlerList = {
	...
	paintTodo: function(todo) {
		if ("content" in document.createElement("template")) {
			...
			const todoCheckBox = clone.querySelector('.todo-item input[type="checkbox"]');
			const todoItemText = clone.querySelector('.todo-item span');
			const todoRemoveBtn = clone.querySelector('.todo-item .remove-btn');
